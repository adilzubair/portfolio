  ...
  return (
    <div className="flex duration-300">
      <blockquote className="flex gap-2 pt-2 text-2xl text-slate-800 md:text-3xl lg:pt-5 lg:text-5xl dark:text-slate-400">
        <QuoteIcon className="-mt-1 h-10 text-blue-600 md:-mt-3 md:h-16 lg:h-24 dark:text-blue-400" />
        <span className="flex flex-col">
          ...
          <span className="leading-[1.15]">
            <strong className="relative font-extrabold text-blue-600 dark:text-blue-400">
              <span className="absolute -left-0.5 right-0 top-1 bottom-0 z-[-1] rounded-md bg-blue-100 px-1 lg:-left-1.5 lg:-right-0.5 lg:top-2 lg:bottom-0" />
              problems.
            </strong>
          </span>
        </span>
