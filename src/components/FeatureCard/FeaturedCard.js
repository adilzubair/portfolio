      ...
      <div className="-mt-0.5">
        <div className="mt-4 mr-2 ml-4 flex items-center justify-between gap-6 rounded-xl bg-neutral-200 dark:bg-slate-800">
          <div className="flex items-center gap-6">
            ...
            <div className="truncate py-2 text-sm font-bold text-slate-700 dark:text-slate-300">
              {title}
            </div>
          </div>
          {subtitle && (
            <div className="py-2 pr-4 text-xs font-medium text-blue-600 dark:text-blue-400">
              {subtitle}
            </div>
          )}
        </div>
